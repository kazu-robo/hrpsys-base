    ...
    public virtual PortableServer::RefCountServantBase
{
  ...
  public:
    ...
    CORBA::Boolean setJumpingFootSteps(const OpenHRP::AutoBalanceStabilizerService::FootstepsSequence& fss, const OpenHRP::AutoBalanceStabilizerService::DblSequence& jump_height_list);
    void waitFootSteps();
